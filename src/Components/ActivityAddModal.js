...
var props = {
  ...
  const AddModal = () => {    
    ...
    async function addActivity(event){
        ...
        console.log(session);
        data.append('activityCreatedBy', session.email);
        
        const response = await fetch(server_URL+'/owners/activityRegister', {
            method: 'POST',
            headers: {
    ...
    return (
        ...
        <div className="modal-overlay">
            {/* Add modal */}
            <div id="addActivityModal" className="modal" style={{display : 'block'}}>                
                    ...
                    <form className="form-inline" id="activity_form" >
                        <div className="row">
                            <div className={styles.imageContainer}>
                                <button className={styles.closeBtn} onClick={() => {document.getElementById('addActivityModal').style.display = 'none'}}>
                                    X
                                </button>
                        ...
                        <div className="row" style={{margin: '2%'}}>
                            ...
                            <div className="col-md-6" >
                                ...
                                <input type="text" className="form-control" name="activityLocation" id="activityLocation" style={{textAlign: 'center'}} />
                            </div>
                        </div>
                        <div className="row" style={{margin: '2%'}}>
                        ...
                        <div className="row">
                            <center>
                                <button className="btn btn-primary" style={{backgroundColor: '#08102a', borderColor: '#08102a', cursor: 'pointer', width: '20%', margin:'5%'}} onClick={addActivity}>
                                    Add
                                </button>
                                <button className="btn btn-primary" style={{backgroundColor: '#08102a', borderColor: '#08102a', cursor: 'pointer', width: '15%', margin:'5%'}} onClick={() => {document.getElementById('addActivityModal').style.display = 'none'}} >
                                    Close
                                </button>
                            </center>
                        </div>
